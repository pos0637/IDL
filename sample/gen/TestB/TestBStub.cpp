...
namespace TestB
{
    EXTERN AXP::Sp<IPC::CObjectHolder> CreateBObjectHolder();

    class BStub : public IPC::IStub
    {
    public:
    ...
    {
        return AXP::ASUCCEEDED(IPC::ServiceManager::RegisterService(L"TestB.B", new TestB::BStub()));
    }
